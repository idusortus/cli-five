...
- **Expo55** — Writes code, fixes bugs, implements logic. Expo SDK 55 specialist that handles all TypeScript, React, React Native, and Expo implementation work.
- **Designer** — Creates UI/UX, styling, visual design
- **Reviewer** — Validates completed work against the plan, existing architecture, and project constitution
...
```
Task 2.1 → Expo55: "Implement the theme context. Create src/contexts/ThemeContext.tsx and src/hooks/useTheme.ts"

Task 2.2 → Expo55: "Create the toggle component in src/components/ThemeToggle.tsx"
```
...
- Task 2.1: Implement theme context and persistence → Expo55
- Task 2.2: Create the toggle component → Expo55
(These can run in parallel - different files)

### Phase 3: Apply Theme (depends on Phase 2)
- Task 3.1: Update all components to use theme tokens → Expo55
```

### Step 3 — Execute
**Phase 1** — Call Designer for both design tasks (parallel)
**Phase 2** — Call Expo55 twice in parallel for context + toggle
**Phase 3** — Call Expo55 to apply theme across components
